...
class Berita extends CI_controller {
	...
	{ 
        ...
        $config['total_rows'] = $this->Model_berita->hitung_berita(); //total row
		...
		$data ['berita'] = $this->Model_berita->tampil_berita_pagination($config['per_page'], $data['page']);
		$data ['terbaru'] = $this->Model_berita->berita_terbaru();
