...
class Informasi extends CI_controller
{
	...
	public function index()
	{
		...
		$data['berita'] = $this->Model_berita->tampil_data();
		$data['lowongan'] = $this->Model_berita->tampil_lowongan();
		...
		$this->load->view('modals/tambah_info');
		$this->load->view('edit/edit_info', $data);
	...
	public function ubah()
	{
		...
		$this->load->model('Model_berita');
		$this->Model_berita->update_info($data, $id_berita);
