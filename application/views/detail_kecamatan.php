<div class="container">
	...
	<div class="row">
		<div class="mx-auto" style="width:90%;">
			...
			<h3 class="text-info"><i class="fas fa-briefcase"></i> Data Pencari Kerja Kecamatan <?php echo $row->nama_nagari; ?></h3>
			<hr>
      <div class="alert alert-primary" role="alert">
            <h6>Total Data Pencari Kerja di Kecamatan <?php echo $row->nama_nagari; ?> :
               <?php echo number_format($total_kecamatan);?> Orang
            </h6></div>
			<div class="span12">
			<div class="table-responsive">
              <table class="table table-striped table-borderless table-hover display" id="dataTables-example" width="auto">
                ...
                ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><a href="<?= base_url(); ?>pencaker/detail_nagari/<?php echo $row->id_nagari2; ?>"><?php echo $row->nama_nagari2; ?><a></td>
                  ...
                  <tfoot class="text-info">
                    <tr>
                    <th colspan="2">Kec. <?php echo $row->nama_nagari; ?></th>
