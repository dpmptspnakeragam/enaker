      ...
      <div class="modal-body">
       <form role="form" action="<?= base_url(); ?>admin/profil/ubah_profil" method="post"  enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <textarea rows="5" class="form-control" name="gambaran_umum" placeholder="Gambaran Umum" required><?php echo $row->gambaran_umum;?></textarea>
          </div>
          <div class="form-group">
              <label for="visi">Visi</label>
              <textarea rows="5" class="form-control" name="visi" placeholder="Gambaran Umum" required><?php echo $row->visi;?></textarea>
          </div>
           <div class="form-group">
              <label for="mis">Misi</label>
              <textarea rows="5" class="form-control" name="misi" placeholder="Gambaran Umum" required><?php echo $row->misi;?></textarea>
          </div>
          <div class="form-group">
              <label for="fungsi">Fungsi</label>
              <textarea rows="5" class="form-control" name="fungsi" placeholder="Gambaran Umum" required><?php echo $row->fungsi;?></textarea>
          </div>
          <div class="form-group">
              <label for="tugas">Tugas</label>
              <textarea rows="5" class="form-control" name="tugas" placeholder="Gambaran Umum" required><?php echo $row->tugas;?></textarea>
          </div>
          <div class="row">
          <div class="form-group">
