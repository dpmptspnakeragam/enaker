...
?>
<div class="modal fade" id="EditBursa<?php echo $row->id_berita; ?>" tabindex="-1" role="dialog" aria-labelledby="ModalInfoLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form role="form" action="<?= base_url(); ?>admin/bursa_kerja/ubah" method="post"  enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <textarea rows="10" class="form-control" type="text" name="isi_berita" required><?php echo $row->isi_berita;?></textarea>
          </div>
          <div class="form-group">
