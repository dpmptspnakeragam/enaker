    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?= base_url(); ?>admin/profil/ubah_anggota" method="post"  enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <option selected><?php echo $row->gol_anggota;?></option><option>IV/e</option><option>IV/d</option><option>IV/c</option><option>IV/b</option><option>IV/a</option>
        ...
        <div class="form-group">
          ...
          <img src="<?php base_url(); ?>assets/imgupload/<?php echo $row->gambar_anggota; ?>" width='80' height='60'/>
          <input name="gambar" type="file" id="gambar" />
          <input name="x" type="hidden" id="x" value="<?php echo $row->gambar_anggota;?>" />
          </div>
        </div></div>
      </div>
