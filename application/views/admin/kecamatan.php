...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12" style="">
            <h3 class="text-center">Data Pencari Kerja <br> Kecamatan "<?php echo $row->nama; ?>"</h3>
            <hr>
            <div class="panel-heading">
                <div class="alert alert-primary" role="alert">
                <h6>Total Data Pencari Kerja di Kecamatan <?php echo $row->nama; ?> :
                   <?php echo number_format($total_kecamatan);?>
                    </h6>
                </div><hr>
      <!---<button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#ModalPencaker"><i class="fa fa-plus fa-fw"></i>Tambah Data</button>--->
        <a href="<?php echo base_url()?>admin/pencaker/cetak_pencaker/<?php echo $row->id_nagari; ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-print fa-fw"></i> Export Data PDF</a>
        <a href="<?php echo base_url()?>admin/pencaker/cetak_rekap_enaker/<?php echo $row->id_nagari; ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-print fa-fw"></i> Export Rekapitulasi PDF</a>
        <button class="btn btn-outline-danger btn-sm" type="button" data-toggle="modal" data-target="#ModalFilterPelatihanKecamatan"><i class="fa fa-file fa-fw"></i> Filter Pelatihan</button>
        <button class="btn btn-outline-danger btn-sm" type="button" data-toggle="modal" data-target="#ModalFilterPendidikanKecamatan"><i class="fa fa-file fa-fw"></i> Filter Pendidikan</button>
        <button class="btn btn-outline-danger btn-sm" type="button" data-toggle="modal" data-target="#ModalFilterUmurKecamatan"><i class="fa fa-file fa-fw"></i> Filter Umur</button>
    </div><br>
            <!-- start: Accordion -->
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover display" id="dataTables-example" width="auto">
                <thead>
                  <tr>
