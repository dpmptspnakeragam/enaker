...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-center">Data Bursa Kerja Khusus <br> <?php echo $row2->nama_sekolah; ?></h3>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-outline-danger btn-sm btn-circle" href="<?php echo base_url() ?>admin/bursa_khusus/hapus/<?php echo $row->id_bk; ?>" title="Hapus" onclick="javascript: return confirm('Anda yakin hapus data ?  Data yang sudah terhapus, tidak dapat dikembalikan lagi.')"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
