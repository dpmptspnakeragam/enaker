...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12" style="">
			<h3 class="text-center">Data Bursa Kerja Khusus <br> <?php echo $row2->nama_sekolah; ?></h3><p class="text-center"><?php echo $row2->alamat; ?></p>
			<hr>
    ...
    <?php endif ;?>
        ...
        <button href="#" class="btn btn-outline-danger btn-sm" type="button" data-toggle="modal" data-target="#ModalFilterSekolah"><i class="fa fa-download"></i> Unduh Data</button>
    </div><br>
            <!-- start: Accordion -->
          <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead class="bg-info text-light" style="">
                                        <tr>
                                            ...
                                            <th class="text-center" width="50" rowspan="2"><i class="fa fa-cog"></i> Aksi</th>
                                        </tr>
                                        <tr>
                                    ...
                                    foreach ( $bursa_khusus->result() as $row ) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-outline-danger btn-sm btn-circle" href="<?php echo base_url()?>admin/bursa_khusus/hapus/<?php echo $row->id_bk; ?>" title="Hapus" onclick="javascript: return confirm('Anda yakin hapus <?= $row->sekolah;?> ?  Data yang sudah terhapus, tidak dapat dikembalikan lagi.')"><i class="fa fa-trash"></i></a>
                                             </div>
                                            </td>
                                        </tr>
                                       <?php } ?>
