...
<div class="modal fade" id="ModalFilterPencakerNagari" tabindex="-1" role="dialog" aria-labelledby="ModalFilterPencaker" aria-hidden="true">
  <div class="modal-dialog modal-lg shadow" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url()?>admin/pencaker/cetak_filter_pelatihan_nagari" method="post" enctype="multipart/form-data">
          <div class="row">
