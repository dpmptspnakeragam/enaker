...
<div class="modal fade" id="ModalFilterPendidikanNagari" tabindex="-1" role="dialog" aria-labelledby="ModalFilterPendidikan" aria-hidden="true">
  <div class="modal-dialog modal-lg shadow" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url()?>admin/pencaker/cetak_filter_pendidikan_nagari" method="post" enctype="multipart/form-data">
          <div class="row">
              <div class="form-group" hidden>
              <input type="text" class="form-control" id="id_kecamatan" name="id_nagari" value="<?php echo $row->id_nagari2;?>">
              </div>
